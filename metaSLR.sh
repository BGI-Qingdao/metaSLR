...
function usage(){
    ...
    echo "                      [ optioal , default 1 ]"
    echo "        --upper       ignore mer with cout > upper."
    echo "                      [ optioal , default 33 ]"
    echo "        --help        print this usage message."
    echo "        "
    echo "Examples :"
    echo "    ./metaSLR.sh --haplotype  s1.a --haplotype s2.fa --haplotype s3.fa --meta read.fq.gz"
    echo ""
    echo "    ./metaSLR.sh --haplotype  s1.a --haplotype s2.fa --haplotype s3.fa \\"
